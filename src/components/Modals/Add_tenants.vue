<template>
  <ModalGlobal ref="global" :saveHandler="save">
    <v-row xs="12" class="pa-0 ma-0 align-baseline" ref="form">
      ...
      <v-col cols="12" sm="4" class="pa-0 ma-0">
        ...
        <p class="font-weight-bold my-10 text-xs-center">Contact information</p>
      </v-col>
      <v-col cols="12" sm="8" class="pa-0 ma-0">
        <v-text-field
          outlined
      ...
      <v-col cols="12" sm="8" class="pa-0 ma-0">
        <v-text-field outlined dense v-model.trim="contactName"> </v-text-field>
      </v-col>
      <v-col cols="12" sm="4" class="pa-0 ma-0">
        <span>Phone number: </span>
      </v-col>
      <v-col cols="12" sm="8" class="pa-0 ma-0">
        <v-text-field outlined dense v-model.trim="phoneNumber"> </v-text-field>
      </v-col>
      <v-col cols="12" sm="4" class="pa-0 ma-0">
        <span>Email: </span>
        <p class="font-weight-bold my-10 text-xs-center">Address information</p>
      </v-col>
